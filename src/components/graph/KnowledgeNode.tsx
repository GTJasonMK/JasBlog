    ...
    >
      ...
      <div
        className={`
          ...
          ${isHovered
            ? "opacity-100 scale-100 bg-[var(--color-vermilion)]/30 border-2 border-[var(--color-vermilion)]"
            : "opacity-0 scale-50"
          }
        `}
      >
        <div className={`w-3 h-3 rounded-full bg-[var(--color-vermilion)] ${isHovered ? "animate-pulse" : ""}`} />
